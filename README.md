...
The multi-stage Dockerfile compiles both frontend and Rust service, runs as a non-root user on port 8080, and keeps SQLite under `/data`. Deployment, DNS, persistent-volume provisioning, and billing product registration are handled outside this repository.
