...
- Live cold recheck at <https://code-lesson-checkpoints.sociobot.in> and <https://code-lesson-checkpoints.sociobot.in/?demo=1> passed after deploying `71f448fa2bc1cfd91c8062da28e1a9b015a611d8`. `BASE_URL=https://code-lesson-checkpoints.sociobot.in npm run test:e2e` and the live URL verifier passed. Screenshots are in `.factory/evidence/polish-2-live/`.
